...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("fuckthemheggiescoin://", Qt::CaseInsensitive))
    {
        Q_EMIT message(tr("URI handling"), tr("'fuckthemheggiescoin://' is not a valid URI. Use 'fuckthemheggiescoin:' instead."),
