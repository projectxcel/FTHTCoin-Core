...
QString formatBitcoinURI(const SendCoinsRecipient &info)
{
    ...
    QString ret = QString("fuckthemheggiescoin:%1").arg(bech_32 ? info.address.toUpper() : info.address);
    int paramCount = 0;
...
fs::path static GetAutostartFilePath()
{
    ...
    return GetAutostartDir() / strprintf("fuckthemheggiescoin-%s.desktop", chain);
}
