// Copyright(C) 2011 - 2020 The Fuckthemheggiescoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FUCKTHEMHEGGIESCOIN_MWEB_MODELS_H
#define FUCKTHEMHEGGIESCOIN_MWEB_MODELS_H
...
#endif // FUCKTHEMHEGGIESCOIN_MWEB_MODELS_H