...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " fuckthemheggiescoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  fuckthemheggiescoin-tx [options] <hex-tx> [commands]  Update hex-encoded fuckthemheggiescoin transaction\n" +
            "or:     fuckthemheggiescoin-tx [options] -create [commands]   Create hex-encoded fuckthemheggiescoin transaction\n" +
            "\n";
