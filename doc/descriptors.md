# Support for Output Descriptors in Fuckthemheggiescoin Core

Since Fuckthemheggiescoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Fuckthemheggiescoin Core wallets, a convenience function `combo` is
