...
"""Verify that starting fuckthemheggiescoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start fuckthemheggiescoin with -h for help text")
        ...
        self.log.info("Start fuckthemheggiescoin with -version for version information")
        ...
        self.log.info("Start fuckthemheggiescoind with -fakearg to make sure it does not start")
